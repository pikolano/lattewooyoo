...
class LatteWooyooMod(loader.Module):
    """Random picture/video/gif from the @lattewooyoo"""
    ...
    async def lattewooyoo(self, message: Message):
        ...
        chosed_msg = choice(
            [
                ...
                async for message_in_channel in self.client.iter_messages(
                    "lattewooyoo", limit=200, filter=search_type
                )
            ]
        )
